...
C3 = zeros(N_realization, length(iternums));
...
for realization_idx = 1 : N_realization
    ...
    for numiters = 1:length(iternums)
        ...
        %% bi-directional training
            ...
            for k1 = 1 : 500
            k1
            [v11, v12, v13] = S_LS_User1_Brutal(H11, H12, H13, H21, H22, H23, H31, H32, H33, g1, g2, g3, v21, v22, v23, v31, v32, v33, n0, w1, w2, w3);
            [v21, v22, v23] = S_LS_User2_Brutal(H11, H12, H13, H21, H22, H23, H31, H32, H33, g1, g2, g3, v11, v12, v13, v31, v32, v33, n0, w1, w2, w3);
            [v31, v32, v33] = S_LS_User3_Brutal(H11, H12, H13, H21, H22, H23, H31, H32, H33, g1, g2, g3, v11, v12, v13, v21, v22, v23, n0, w1, w2, w3); 
            %[v11, v12, v13]
            %[v21, v22, v23]
            %[v31, v32, v33]
            norm(v11)^2+norm(v12)^2+norm(v13)^2
            norm(v21)^2+norm(v22)^2+norm(v23)^2
